---
name: busa-messenger
description: Unified chat inbox (Busabase App-in-Skill) aggregating WhatsApp, Discord, Slack, and Telegram messages into one place with a reply queue. Use when the user invokes $busa-messenger or /busa-messenger, wants a unified inbox, chat aggregation, to read WhatsApp/Discord/Slack/Telegram messages in one place, review unanswered conversations, queue or approve replies, run connector sync, or manage the outgoing reply queue.
metadata:
  category: comms
  tags:
    - risk:gated-write
...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa Messenger overview"></td>
    <td width="50%"><img src="assets/screenshots/chat.webp" alt="Busa Messenger conversation"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/inbox.webp" alt="Busa Messenger unified inbox"></td>
    <td width="50%"><img src="assets/screenshots/outbox.webp" alt="Busa Messenger reply outbox"></td>
  </tr>
  <tr>
...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual
   quality, responsive layout, and the complete canonical `content/busa-messenger-app/` artifact.
...
Six Bases under one application Folder (`busa-messenger`), declared in
`content/busa-messenger-app/app/js/config.js` and the generated template sidecars under `content/`:
...
```bash
node skills/busa-messenger/scripts/ingest_messages.mjs onboarding-payload.json --apply
```
...
Start `pnpm --dir content/busa-messenger-app dev` only when local preview/debugging is explicitly
requested.
...
```bash
node skills/busa-messenger/scripts/sync_messages.mjs
node skills/busa-messenger/scripts/sync_messages.mjs --apply
node skills/busa-messenger/scripts/ingest_messages.mjs payload.json --apply
node skills/busa-messenger/scripts/send_outbox.mjs
node skills/busa-messenger/scripts/send_outbox.mjs --send
pnpm --dir skills/busa-messenger/content/busa-messenger-app dev
```

In normal use, invoke `/busa-messenger`, let the skill sync/ingest the
