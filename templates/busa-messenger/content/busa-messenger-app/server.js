...
const AIRAPP_ID = "busa-messenger";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-messenger" }));
...
app.onError((error, context) => {
  console.error("busa-messenger server error", error instanceof Error ? error.message : error);
