...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Messenger must be Cloud-only");
...
console.log(`Busa Messenger AirApp checks OK (${files.length} files)`);
