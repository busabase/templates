...
<table>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/accounts.webp" alt="Busa Messenger accounts"></td>
  </tr>
  <tr>
...
```bash
node skills/busa-messenger/scripts/ingest_messages.mjs onboarding-payload.json --apply  # register an account (payload.account)
node skills/busa-messenger/scripts/sync_messages.mjs --apply                            # read-only API sync (friendly no-op without tokens)
node skills/busa-messenger/scripts/ingest_messages.mjs payload.json --apply             # browser_agent/manual message payloads
node skills/busa-messenger/scripts/send_outbox.mjs                                      # dry-run
node skills/busa-messenger/scripts/send_outbox.mjs --send                               # execute approved replies
```
