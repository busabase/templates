...
app.get("/health", (context) => context.json({ ok: true, app: "busa-writer" }));
...
app.onError((error, context) => {
  console.error("busa-writer server error", error instanceof Error ? error.message : error);
