...
export const busabaseProvider = {
  ...
  async getState() {
    ...
    const profileRow = settings.get("busa-writer-profile") || {};
    const lockRow = settings.get("busa-writer-lock") || {};
    ...
    return {
      ...
      config_summary: {
        config_path: profileRow.record_id ? "busabase:base/busa-writer-settings" : "",
        is_example: false,
        brand: profile.brand || {},
