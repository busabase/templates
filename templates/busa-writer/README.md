...
Busa Writer is a Busabase-backed App-in-Skill review desk for repurposing one source idea, blog post, transcript, or announcement into channel-ready drafts — Xiaohongshu, WeChat, newsletter, LinkedIn, X/Twitter, short video scripts, SEO snippets, and an official blog draft. The agent drafts each channel variant; you review, edit, and approve drafts in a quiet review UI before anything is exported.
...
```bash
pnpm --dir content/busa-writer-app install
pnpm --dir content/busa-writer-app dev
```
