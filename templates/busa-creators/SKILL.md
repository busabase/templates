...
Busa Creators is a Busabase Cloud App-in-Skill. Its canonical product
...
connection bootstrap. Use this skill as the operator's personal influencer/creator
...
whatever the operator feeds it — a niche, a brand brief, a competitor's creators, an
...
or `busa-email`) after explicit approval.
...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual
   quality, responsive layout, and the complete canonical `content/busa-creators-app/` artifact.
...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa Creators overview"></td>
    <td width="50%"><img src="assets/screenshots/creators.webp" alt="Busa Creators candidates"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/outreach.webp" alt="Busa Creators outreach queue"></td>
    <td width="50%"><img src="assets/screenshots/roi.webp" alt="Busa Creators ROI board"></td>
  </tr>
  <tr>
...
- The skill may read sources the operator provides, sweep and score creators, draft outreach/briefs/contracts, run content gates, and write to Busabase.
...
On invocation, check the `busa-creators-profile` settings row for
...
Two Bases under one application Folder (`busa-creators`), declared in
`content/busa-creators-app/app/js/config.js` and the generated template sidecars under `content/`:
...
- `settings`: one row per `kind` — `busa-creators-profile` (operator profile, brand(s), program budget/currency/niches, style tone, platforms) and `busa-creators-lock`.
...
Start `pnpm --dir content/busa-creators-app dev` only when local preview/debugging is explicitly
requested.
