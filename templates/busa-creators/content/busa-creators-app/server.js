...
app.get("/health", (context) => context.json({ ok: true, app: "busa-creators" }));
...
app.onError((error, context) => {
  console.error("busa-creators server error", error instanceof Error ? error.message : error);
