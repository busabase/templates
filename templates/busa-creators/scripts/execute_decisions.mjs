#!/usr/bin/env node
// Trusted hand-off step. Busa Creators' AirApp only ever proposes an
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Busa Creators Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
