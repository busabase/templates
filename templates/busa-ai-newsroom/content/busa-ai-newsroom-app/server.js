...
const AIRAPP_ID = "busa-ai-newsroom";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-ai-newsroom" }));
...
app.onError((error, context) => {
  console.error("busa-ai-newsroom server error", error instanceof Error ? error.message : error);
