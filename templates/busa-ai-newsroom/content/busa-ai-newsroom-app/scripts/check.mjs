...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa AI Newsroom must be Cloud-only");
...
console.log(`Busa AI Newsroom AirApp checks OK (${files.length} files)`);
