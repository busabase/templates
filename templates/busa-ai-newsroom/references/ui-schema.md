# Busa AI Newsroom Schema

Use this schema when reading or writing Busa AI Newsroom's Busabase Bases.
Field slugs are kebab-case in Busabase and normalized to snake_case in app
code (`content/busa-ai-newsroom-app/app/js/providers/busabase-provider.js`,
`content/busa-ai-newsroom-app/app/js/newsroom-model.js`). The batch rollup metrics
...
## Signals (`busa-ai-newsroom-signals`)
...
## Actions (`busa-ai-newsroom-actions`)
...
## Drafts (`busa-ai-newsroom-drafts`)
...
## Sources (`busa-ai-newsroom-sources`)
...
## Settings (`busa-ai-newsroom-settings`)
...
(`operationForDecision()` in `content/busa-ai-newsroom-app/app/js/newsroom-model.js`) for every
