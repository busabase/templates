...
```bash
pnpm --dir skills/busa-portfolio-health/content/busa-portfolio-health-app dev
```
...
cities, ported verbatim from the retired `content/busa-portfolio-health-app/server/dataset.ts`) and never
...
Bases declared in `content/busa-portfolio-health-app/app/js/config.js` (see
