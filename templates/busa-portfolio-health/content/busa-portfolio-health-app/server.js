...
const AIRAPP_ID = "busa-portfolio-health";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-portfolio-health" }));
...
app.onError((error, context) => {
  console.error("busa-portfolio-health server error", error instanceof Error ? error.message : error);
