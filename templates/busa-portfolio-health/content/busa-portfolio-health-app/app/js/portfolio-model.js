// Domain model for Busa Portfolio Health: a revenue-based-financing (RBF) /
...
export function buildConfigSummary(payload = {}) {
  return {
    config_path: "busabase:base/busa-portfolio-health-settings",
    is_example: false,
