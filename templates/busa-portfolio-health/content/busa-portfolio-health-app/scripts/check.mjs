...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Portfolio Health must be Cloud-only");
...
console.log(`Busa Portfolio Health AirApp checks OK (${files.length} files)`);
