...
export const LANGUAGE_STORAGE_KEY = "busa-email.uiLanguage";
export const ACCENT_THEME_STORAGE_KEY = "busa-email.accentTheme";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "busa-email.sidebarCollapsed";
