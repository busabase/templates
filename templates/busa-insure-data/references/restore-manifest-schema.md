# Busa Insure Data Restore Manifest

The restore manifest is a portable backup description for rebuilding a Busa Insure Data Busabase workspace after a destructive reset.
...
This manifest is not a full Busabase database dump. It is scoped to the Busa Insure Data workspace contract: one folder, one Drive, one Featured Information Base, one Insurer Notices Base, one QA Base, and one User Feedback Base.
