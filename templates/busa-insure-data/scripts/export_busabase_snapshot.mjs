...
// metadata) for the active Busa Insure Data Busabase workspace. Ported
...
const output = String(
  args.output || path.join(skillDir, "content", "busa-insure-data-app", ".data", "busabase_restore_manifest.json"),
);
const folderSlug = String(args.folderSlug || args["folder-slug"] || "hk-insurance-company-folders");
const driveSlug = String(args.driveSlug || args["drive-slug"] || "busa-insure-data-files");
const featuredSlug = String(args.featuredSlug || args["featured-slug"] || "busa-insure-data-featured");
const noticesSlug = String(
  args.noticesSlug || args["notices-slug"] || args.newsSlug || args["news-slug"] || "busa-insure-data-notices",
);
const qaSlug = String(args.qaSlug || args["qa-slug"] || "busa-insure-data-qa");
const feedbackSlug = String(args.feedbackSlug || args["feedback-slug"] || "busa-insure-data-feedback");
