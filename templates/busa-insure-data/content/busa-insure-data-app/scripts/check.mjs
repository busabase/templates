...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Insure Data must be Cloud-only");
if (!configText.includes("readOnly: true")) throw new Error("Busa Insure Data AirApp must declare readOnly: true");
if (!configText.includes("writeProcedures: []"))
  throw new Error("Busa Insure Data AirApp must declare no writeProcedures");
...
console.log(`Busa Insure Data AirApp checks OK (${files.length} files)`);
