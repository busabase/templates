...
const AIRAPP_ID = "busa-insure-data";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-insure-data" }));
...
app.onError((error, context) => {
  console.error("busa-insure-data server error", error instanceof Error ? error.message : error);
