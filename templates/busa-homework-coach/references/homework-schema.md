# Busa Homework Coach Schema

Use this schema when reading or writing Busa Homework Coach's Busabase
Bases. Field slugs are kebab-case in Busabase and normalized to snake_case
in app code (`content/busa-homework-coach-app/app/js/providers/busabase-provider.js`,
`content/busa-homework-coach-app/app/js/homework-model.js`). `active_questions`/`mistakes_total`/
...
## Questions (`busa-homework-coach-questions`)
...
## Mistakes (`busa-homework-coach-mistakes`)
...
## Papers (`busa-homework-coach-papers`)
...
## Reviews (`busa-homework-coach-reviews`)
