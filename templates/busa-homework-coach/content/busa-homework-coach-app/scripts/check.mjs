...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Homework Coach must be Cloud-only");
...
console.log(`Busa Homework Coach AirApp checks OK (${files.length} files)`);
