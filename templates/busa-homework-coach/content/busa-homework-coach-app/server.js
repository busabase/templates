...
const AIRAPP_ID = "busa-homework-coach";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-homework-coach" }));
...
app.onError((error, context) => {
  console.error("busa-homework-coach server error", error instanceof Error ? error.message : error);
