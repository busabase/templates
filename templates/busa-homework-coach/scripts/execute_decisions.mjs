#!/usr/bin/env node
// Trusted hand-off step. Busa Homework Coach's AirApp only ever records a
...
import { baseReviewFields, computeReviewFromRow } from "../content/busa-homework-coach-app/app/js/homework-model.js";
    ...
    if (review.decision.action === "approve") {
      ...
      if (apply) {
        await client.records.changeRequest({
          ...
          author: "busa-homework-coach-executor",
