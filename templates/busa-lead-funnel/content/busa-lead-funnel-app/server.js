...
const AIRAPP_ID = "busa-lead-funnel";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-lead-funnel" }));
...
app.onError((error, context) => {
  console.error("busa-lead-funnel server error", error instanceof Error ? error.message : error);
