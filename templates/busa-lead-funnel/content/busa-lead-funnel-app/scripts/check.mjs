...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Lead Funnel must be Cloud-only");
...
console.log(`Busa Lead Funnel AirApp checks OK (${files.length} files)`);
