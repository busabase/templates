...
- **Deterministic lead-quality score** (0-100,
  `content/busa-lead-funnel-app/app/js/lead-funnel-model.js`, not an LLM call) from four weighted,
...
```bash
pnpm --dir skills/busa-lead-funnel/content/busa-lead-funnel-app dev
```
...
settings all live in Busabase Bases declared in `content/busa-lead-funnel-app/app/js/config.js` (see
