#!/usr/bin/env node
// Trusted hand-off step. Busa Audit's AirApp only ever proposes a review
...
import { planExecution } from "../content/busa-audit-app/app/js/audit-model.js";
  ...
  for (const row of approved) {
    ...
    if (apply) {
      await client.records.changeRequest({
        ...
        author: "busa-audit-execute-decisions",
