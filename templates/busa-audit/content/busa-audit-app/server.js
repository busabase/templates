...
app.get("/health", (context) => context.json({ ok: true, app: "busa-audit" }));
...
app.onError((error, context) => {
  console.error("busa-audit server error", error instanceof Error ? error.message : error);
