// Thin trusted-process Busabase REST client for busa-demo-video-factory's
...
export const VIDEOS_BASE_SLUG = "busa-demo-video-factory-videos";
export const SHOTS_BASE_SLUG = "busa-demo-video-factory-video-shots";
