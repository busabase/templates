...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Demo Video Factory must be Cloud-only");
if (!configText.includes("readOnly: true")) throw new Error("Busa Demo Video Factory AirApp must be read-only");
...
console.log(`Busa Demo Video Factory AirApp checks OK (${files.length} files)`);
