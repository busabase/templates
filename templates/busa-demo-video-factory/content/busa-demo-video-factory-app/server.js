...
const AIRAPP_ID = "busa-demo-video-factory";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-demo-video-factory" }));
...
app.onError((error, context) => {
  console.error("busa-demo-video-factory server error", error instanceof Error ? error.message : error);
