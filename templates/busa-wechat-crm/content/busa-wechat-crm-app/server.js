...
const gateway = createBusabaseAirAppLocalGateway({
  appId: "busa-wechat-crm",
  successPath: "/",
  errorPath: "/",
  requestTimeoutMs: 30_000,
});

app.get("/health", (context) => context.json({ ok: true, app: "busa-wechat-crm" }));
...
app.onError((error, context) => {
  console.error("busa-wechat-crm server error", error instanceof Error ? error.message : error);
