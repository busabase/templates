...
// evaluates every draft via content/busa-listing-app/app/js/listing-model.js's evaluateDraft()
// (ported verbatim from the retired content/busa-listing-app/server/rules.ts), upserts the Checks
...
import {
  ...
  ruleCatalog,
  scoreChecks,
} from "../content/busa-listing-app/app/js/listing-model.js";
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-listing-checks",
    autoMerge: true,
  });
  return "created";
}
