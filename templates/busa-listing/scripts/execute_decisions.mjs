#!/usr/bin/env node
// Trusted hand-off step. Busa Listing's AirApp only ever proposes a review
...
// (content/busa-listing-app/app/js/listing-model.js's doc comment explains the adaptation: one
...
import { draftExecution, normalizeProductRow } from "../content/busa-listing-app/app/js/listing-model.js";
  ...
  for (const row of decided) {
    ...
    if (apply) {
      await client.records.changeRequest({
        ...
        author: "busa-listing-execute-decisions",
