#!/usr/bin/env node
// Trusted hand-off step. Busa Listing's AirApp never ingests product source
...
// content/busa-listing-app/.data/listing_snapshot.json to Busabase's products/drafts Bases.
//
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-listing-ingest",
    autoMerge: true,
  });
  return "created";
}
