...
app.get("/health", (context) => context.json({ ok: true, app: "busa-listing" }));
...
app.onError((error, context) => {
  console.error("busa-listing server error", error instanceof Error ? error.message : error);
