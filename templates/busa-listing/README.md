...
<table>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/claims.webp" alt="Busa Listing claims registry"></td>
    <td width="50%"><img src="assets/screenshots/products.webp" alt="Busa Listing products"></td>
  </tr>
  <tr>
...
Busa Listing provisions its own Folder and six Bases (`products`, `drafts`, `checks`, `claims`, `claim-rules`, `settings`) lazily on first run in a Busabase Space — no manual setup required. See `SKILL.md`'s Busabase Resources section.
