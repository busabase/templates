#!/usr/bin/env node
// Push this skill's current local content/busa-legal-contracts-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/busa-legal-contracts-app/ files; scripts/setup.mjs
...
const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "busa-legal-contracts-app");
