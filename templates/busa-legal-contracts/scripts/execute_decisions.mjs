#!/usr/bin/env node
// Trusted hand-off step. Busa Legal Contracts's AirApp only ever proposes a
...
// (content/busa-legal-contracts-app/app/js/contracts-model.js's doc comment explains the adaptation: one
...
import { issueExecution, normalizeContractRow } from "../content/busa-legal-contracts-app/app/js/contracts-model.js";
  ...
  for (const row of decided) {
    ...
    if (apply) {
      await client.records.changeRequest({
        ...
        author: "busa-legal-contracts-execute-decisions",
