...
// evaluates every issue via content/busa-legal-contracts-app/app/js/contracts-model.js's evaluateIssue()
// (ported verbatim from the retired content/busa-legal-contracts-app/server/rules.ts), upserts the Checks
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  if (existing) {
    await client.records.changeRequest({
      ...
      fields: normalized,
      message,
      author: "busa-legal-contracts-checks",
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-legal-contracts-checks",
    autoMerge: true,
  });
  return "created";
}
