...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Legal Contracts must be Cloud-only");
...
console.log(`Busa Legal Contracts AirApp checks OK (${files.length} files)`);
