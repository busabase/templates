...
const AIRAPP_ID = "busa-legal-contracts";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-legal-contracts" }));
...
app.onError((error, context) => {
  console.error("busa-legal-contracts server error", error instanceof Error ? error.message : error);
