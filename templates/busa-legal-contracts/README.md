...
<table>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/playbook.webp" alt="Busa Legal Contracts clause playbook"></td>
    <td width="50%"><img src="assets/screenshots/contracts.webp" alt="Busa Legal Contracts contract register"></td>
  </tr>
  <tr>
...
Busa Legal Contracts provisions its own Folder and six Bases (`contracts`, `issues`, `checks`, `claims`, `claim-rules`, `settings`) lazily on first run in a Busabase Space — no manual setup required. See `SKILL.md`'s Busabase Resources section.
