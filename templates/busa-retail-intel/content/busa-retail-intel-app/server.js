...
const AIRAPP_ID = "busa-retail-intel";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-retail-intel" }));
...
app.onError((error, context) => {
  console.error("busa-retail-intel server error", error instanceof Error ? error.message : error);
