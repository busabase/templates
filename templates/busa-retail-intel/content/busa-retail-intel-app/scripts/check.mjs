...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Retail Intel must be Cloud-only");
...
console.log(`Busa Retail Intel AirApp checks OK (${files.length} files)`);
