...
import { operationForDecision } from "../content/busa-retail-intel-app/app/js/retail-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "busa-retail-intel-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Busa Retail Intel Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
