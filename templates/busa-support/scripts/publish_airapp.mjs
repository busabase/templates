#!/usr/bin/env node
// Push this skill's current local content/busa-support-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/busa-support-app/ files; scripts/setup.mjs
...
import { appConfig } from "../content/busa-support-app/app/js/config.js";

const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "busa-support-app");
