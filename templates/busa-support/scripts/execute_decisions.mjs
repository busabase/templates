#!/usr/bin/env node
// Trusted hand-off step. Busa Support's AirApp only ever proposes a review
...
import { buildSnapshot } from "../content/busa-support-app/app/js/support-model.js";
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Busa Support Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
