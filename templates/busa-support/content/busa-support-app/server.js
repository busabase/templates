...
app.get("/health", (context) => context.json({ ok: true, app: "busa-support" }));
...
app.onError((error, context) => {
  console.error("busa-support server error", error instanceof Error ? error.message : error);
