...
const AIRAPP_ID = "busa-followups";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-followups" }));
...
app.onError((error, context) => {
  console.error("busa-followups server error", error instanceof Error ? error.message : error);
