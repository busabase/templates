export const appConfig = {
  appId: "busa-followups",
  appName: "Busa Followups",
  deployment: "cloud",
  locale: "auto",
  readOnly: false,
  spaceId: "",
  ...
  airApp: { name: "Busa Followups", slug: "busa-followups-app", resourceKey: "busa-followups-app" },
  bases: [
    {
      key: "followups",
      name: "跟进事项",
      slug: "busa-followups-followups",
