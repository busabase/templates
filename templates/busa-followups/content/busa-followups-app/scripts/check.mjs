...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Followups must be Cloud-only");
...
console.log(`Busa Followups AirApp checks OK (${files.length} files)`);
