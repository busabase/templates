# Busa Followups Schema

Use this schema when reading or writing Busa Followups's one Busabase Base.
Field slugs are kebab-case in Busabase and normalized to snake_case in app
code (`content/busa-followups-app/app/js/followups-model.js`,
`content/busa-followups-app/app/js/providers/busabase-provider.js`).

## Followups (`busa-followups-followups`)
