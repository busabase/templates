...
Busa Followups is a Busabase-backed App-in-Skill that does one thing: after
...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/today.webp" alt="Busa Followups today view"></td>
  </tr>
</table>

## Origin

This skill is a worked example of the `$busa-ideas` → `$kelly-app-creator`
...
`$busa-ideas`'s BRD → MRD → PRD ladder. The resulting PRD's own non-goals
...
`busa-followups` Folder. See `SKILL.md` for the resource map. Connects with
