...
const AIRAPP_ID = "busa-pr-review";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-pr-review" }));
...
app.onError((error, context) => {
  console.error("busa-pr-review server error", error instanceof Error ? error.message : error);
