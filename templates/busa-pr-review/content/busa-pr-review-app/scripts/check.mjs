...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa PR Review must be Cloud-only");
...
console.log(`Busa PR Review AirApp checks OK (${files.length} files)`);
