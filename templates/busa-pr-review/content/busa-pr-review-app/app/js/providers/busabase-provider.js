...
export const busabaseProvider = {
  ...
  async getState() {
    ...
    const profileRow = settings.get("busa-pr-review-profile") || {};
    const lockRow = settings.get("busa-pr-review-lock") || {};
    ...
    return {
      ...
      config_summary: {
        ...
        source: profileRow.record_id ? "busabase:base/busa-pr-review-settings" : "",
