...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual
   quality, responsive layout, and the complete canonical `content/busa-family-fund-app/` artifact.
...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa Family Fund overview"></td>
    <td width="50%"><img src="assets/screenshots/ledger.webp" alt="Busa Family Fund ledger"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/category.webp" alt="Busa Family Fund by category"></td>
    <td width="50%"><img src="assets/screenshots/family.webp" alt="Busa Family Fund fairness by family"></td>
  </tr>
  <tr>
...
Five Bases under one application Folder (`busa-family-fund`), declared in
`content/busa-family-fund-app/app/js/config.js` and the generated template sidecars under `content/`:
...
Busa Family Fund's AirApp is read-only; `scripts/import_csv.mjs` is the only
...
Start `pnpm --dir content/busa-family-fund-app dev` only when local preview/debugging is explicitly
...
Read `references/fund-schema.md` before editing the app, `content/busa-family-fund-app/app/js/config.js`,
