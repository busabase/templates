...
export const demoProvider = {
  ...
  async getState() {
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "demo://busa-family-fund/config.json",
        is_example: false,
      ...
      demo_visuals: demoVisualsForApp("busa-family-fund"),
      snapshot: { ...snapshot, demo_visuals: demoVisualsForApp("busa-family-fund") },
    };
  },
