...
const AIRAPP_ID = "busa-family-fund";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-family-fund" }));
...
app.onError((error, context) => {
  console.error("busa-family-fund server error", error instanceof Error ? error.message : error);
