...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Family Fund must be Cloud-only");
...
console.log(`Busa Family Fund AirApp checks OK (${files.length} files)`);
