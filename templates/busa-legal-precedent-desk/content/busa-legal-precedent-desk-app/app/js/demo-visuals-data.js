...
const SKILL_NAME = "busa-legal-precedent-desk";
const ACCENTS = ["#1e40af", "#0f766e"];
const VISUAL_DEFS = [
  {
    id: "busa-legal-precedent-desk-visual-1",
    title: "Case card",
    caption: "Synthetic precedent card with holding, court, and use note.",
    kind: "document",
  },
  {
    id: "busa-legal-precedent-desk-visual-2",
    title: "Citation graph",
    caption: "Mock precedent citation and treatment network.",
    kind: "board",
  },
  {
    id: "busa-legal-precedent-desk-visual-3",
    title: "Research pack",
