...
const AIRAPP_ID = "busa-legal-precedent-desk";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-legal-precedent-desk" }));
...
app.onError((error, context) => {
  console.error("busa-legal-precedent-desk server error", error instanceof Error ? error.message : error);
