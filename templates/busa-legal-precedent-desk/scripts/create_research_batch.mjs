...
import { ITEM_LABEL_EN } from "../content/busa-legal-precedent-desk-app/app/js/precedent-model.js";
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  if (existing) {
    await client.records.changeRequest({
      ...
      fields: normalized,
      message,
      author: "busa-legal-precedent-desk-create-research-batch",
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-legal-precedent-desk-create-research-batch",
    autoMerge: true,
  });
  return "created";
}
