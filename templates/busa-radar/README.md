...
Busa Radar is a Busabase App-in-Skill market-intelligence desk. One app merges competitor monitoring (Radar), agent-run deep research (Research), and demand signals (Trends) over a shared Busabase snapshot, watchlist, and review model.

## What It Shows

- Overview: what needs the operator's attention (signals to triage, briefs to approve, reports to read, follow-ups running), watchlist freshness, top signals, top trend movers, and the research pipeline.
...
2. The operator triages signals, approves research briefs, rates report confidence, and approves opportunity cards in the app; verdicts write directly onto the item record through `busabase-sdk`.
...
<table>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/watchlist.webp" alt="Busa Radar watchlist"></td>
  </tr>
  <tr>
...
Collection and research are read-only over public pages and the operator's own analytics — respect robots.txt and terms of service, throttle politely, and never scrape private or personal data. Handoffs and any outbound artifacts require the operator's approval in the app first.
