...
app.get("/health", (context) => context.json({ ok: true, app: "busa-radar" }));
...
app.onError((error, context) => {
  console.error("busa-radar server error", error instanceof Error ? error.message : error);
