...
Busa Money is a Busabase-backed App-in-Skill dashboard for aggregating Mercury, Stripe, Airwallex, and Creem into one money ledger.
...
```bash
pnpm --dir content/busa-money-app install
pnpm --dir content/busa-money-app dev
```
