...
app.get("/health", (context) => context.json({ ok: true, app: "busa-money" }));
...
app.onError((error, context) => {
  console.error("busa-money server error", error instanceof Error ? error.message : error);
