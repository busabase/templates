...
Use this schema when reading or writing Busa DevOps's Busabase Bases. Field
slugs are kebab-case in Busabase and normalized to snake_case in app code
(`content/busa-devops-app/app/js/providers/busabase-provider.js`, `content/busa-devops-app/app/js/devops-model.js`).
...
## Spend Providers (`busa-devops-spend-providers`)
...
## Spend Products (`busa-devops-spend-products`)
