...
app.get("/health", (context) => context.json({ ok: true, app: "busa-devops" }));
...
app.onError((error, context) => {
  console.error("busa-devops server error", error instanceof Error ? error.message : error);
