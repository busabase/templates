...
if (manifest.name !== "busa-portrait-retouch") throw new Error("template manifest app id mismatch");
...
console.log(`Busa Portrait Retouch AirApp checks OK (${files.length} files)`);
