...
const AIRAPP_ID = "busa-portrait-retouch";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-portrait-retouch" }));
...
app.onError((error, context) => {
  console.error("busa-portrait-retouch server error", error instanceof Error ? error.message : error);
