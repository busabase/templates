...
function settingsPanel(tab) {
  if (tab === "resources")
    return "<dl><dt>Folder</dt><dd>busa-portrait-retouch</dd><dt>Bases</dt><dd>jobs · candidates · settings</dd><dt>Images</dt><dd>Busabase Assets; Base rows store asset IDs</dd><dt>Schema</dt><dd>v1</dd></dl>";
  if (tab === "privacy")
