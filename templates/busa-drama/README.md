...
Busa Drama is a Busabase-backed App-in-Skill workbench for planning short-drama series: series bible, character consistency cards, relationship map, episode ladder, and storyboard shots, with AI image/video/voice generation hooks and a HyperFrame handoff for final motion work.
...
```bash
pnpm --dir content/busa-drama-app install
pnpm --dir content/busa-drama-app run build:sdk
pnpm --dir content/busa-drama-app dev
```
