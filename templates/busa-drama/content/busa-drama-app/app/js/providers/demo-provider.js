...
// browser — never a real generated/uploaded asset (busa-mv's demo-provider.js,
// this skill's closest architectural twin, does the same for its own assets).
...
function demoStatePayload(project) {
  return {
    ...
    lock: { locked: false },
    config_summary: { config_path: "demo://busa-drama/project.json", is_example: false },
    project,
    projects: [
      {
