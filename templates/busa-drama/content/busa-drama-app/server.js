...
app.get("/health", (context) => context.json({ ok: true, app: "busa-drama" }));
...
// Busa Drama-specific addition (not part of the shared template every other
...
app.onError((error, context) => {
  console.error("busa-drama server error", error instanceof Error ? error.message : error);
