...
// cache it onto the Busa Drama project record (`hyperframe_status_json` +
// `hyperframe_status_updated_at`). Ported verbatim from the retired
// content/busa-drama-app/server/hyperframe-service.ts's hyperframeProjectStatus() — this was
...
function projectFieldsFromRow(row = {}) {
  return {
    project_id: row.project_id || "busa-drama-project",
    title: row.title || "",
    logline: row.logline || "",
    genre: row.genre || "",
...
async function main() {
  ...
  await upsert(
    ...
    "project-id",
    projectRow.project_id || "busa-drama-project",
    {
