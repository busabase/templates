...
Use this schema when reading or writing Busa Lesson's Busabase Bases. Field
slugs are kebab-case in Busabase and normalized to snake_case in app code
(`content/busa-lesson-app/app/js/providers/busabase-provider.js`, `content/busa-lesson-app/app/js/lesson-model.js`).
