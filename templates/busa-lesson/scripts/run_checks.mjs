...
// rule via content/busa-lesson-app/app/js/lesson-model.js's evaluateCheck() (ported verbatim from
...
import { computeComplianceScore, evaluateCheck } from "../content/busa-lesson-app/app/js/lesson-model.js";
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-lesson-checks",
    autoMerge: true,
  });
  return "created";
}
