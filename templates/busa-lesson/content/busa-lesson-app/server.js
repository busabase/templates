...
app.get("/health", (context) => context.json({ ok: true, app: "busa-lesson" }));
...
app.onError((error, context) => {
  console.error("busa-lesson server error", error instanceof Error ? error.message : error);
