...
function demoItems() {
  return [
    ...
    item(
      ...
      "no_action",
      "approved",
      "Runbook drafted with an ordered timeline and a war-room note per step. On-call: the operator (comms), Dana (infra), Priya (support).",
...
export const demoProvider = {
  ...
  async getState() {
    ...
    snapshot.source = "busa-launch-demo";
    snapshot.product = {
      name: "Trailhead",
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "demo://busa-launch/config.json",
        is_example: false,
      ...
      decisions: {},
      demo_visuals: demoVisualsForApp("busa-launch"),
      snapshot: { ...snapshot, demo_visuals: demoVisualsForApp("busa-launch") },
    };
  },
