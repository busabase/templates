export const appConfig = {
  ...
  airApp: { name: "Busa Launch", slug: "busa-launch-app", resourceKey: "busa-launch-app" },
  bases: [
    {
      key: "items",
      name: "Launch Items",
      slug: "busa-launch-items",
