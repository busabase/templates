...
app.get("/health", (context) => context.json({ ok: true, app: "busa-launch" }));
...
app.onError((error, context) => {
  console.error("busa-launch server error", error instanceof Error ? error.message : error);
