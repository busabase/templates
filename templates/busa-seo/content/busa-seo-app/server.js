...
app.get("/health", (context) => context.json({ ok: true, app: "busa-seo" }));
...
app.onError((error, context) => {
  console.error("busa-seo server error", error instanceof Error ? error.message : error);
