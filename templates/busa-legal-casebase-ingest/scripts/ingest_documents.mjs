...
import { ITEM_LABEL_EN } from "../content/busa-legal-casebase-ingest-app/app/js/casebase-model.js";
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  if (existing) {
    await client.records.changeRequest({
      ...
      fields: normalized,
      message,
      author: "busa-legal-casebase-ingest-ingest",
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-legal-casebase-ingest-ingest",
    autoMerge: true,
  });
  return "created";
}
