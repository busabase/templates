...
const AIRAPP_ID = "busa-legal-casebase-ingest";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-legal-casebase-ingest" }));
...
app.onError((error, context) => {
  console.error("busa-legal-casebase-ingest server error", error instanceof Error ? error.message : error);
