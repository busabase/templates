...
const SKILL_NAME = "busa-legal-casebase-ingest";
const ACCENTS = ["#1e40af", "#7c3aed"];
const VISUAL_DEFS = [
  {
    id: "busa-legal-casebase-ingest-visual-1",
    title: "Case PDF scan",
    caption: "Synthetic judgment page with source and citation markers.",
    kind: "document",
  },
  {
    id: "busa-legal-casebase-ingest-visual-2",
    title: "Entity graph",
    caption: "Mock parties, court, statute, and topic extraction map.",
    kind: "board",
  },
  {
    id: "busa-legal-casebase-ingest-visual-3",
    title: "Dedupe queue",
