...
const AIRAPP_ID = "busa-expo-leads";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-expo-leads" }));
...
app.onError((error, context) => {
  console.error("busa-expo-leads server error", error instanceof Error ? error.message : error);
