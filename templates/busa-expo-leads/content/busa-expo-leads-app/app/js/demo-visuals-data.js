...
const SKILL_NAME = "busa-expo-leads";
const ACCENTS = ["#0f766e", "#4f46e5"];
const VISUAL_DEFS = [
  {
    id: "busa-expo-leads-visual-1",
    title: "Booth lead profile",
    caption: "Synthetic buyer profile captured at the booth, with batch and SLA context.",
    kind: "profile",
  },
  {
    id: "busa-expo-leads-visual-2",
    title: "SLA countdown board",
    caption: "Mock green/amber/red buckets showing which leads are about to miss the 24h window.",
    kind: "timeline",
  },
  {
    id: "busa-expo-leads-visual-3",
    title: "Follow-up draft",
    caption: "Multilingual follow-up draft card prepared for human approval.",
    kind: "document",
  },
];
