...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Expo Leads must be Cloud-only");
...
console.log(`Busa Expo Leads AirApp checks OK (${files.length} files)`);
