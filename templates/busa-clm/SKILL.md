...
Busa CLM is a Busabase Cloud App-in-Skill. Its canonical product surface is
...
This skill is intentionally simpler than `busa-legal-contracts`: use
`busa-clm` for contract operations and reminders; use `busa-legal-contracts`
...
same way `busa-lead-funnel`'s kanban stage moves and
...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual
   quality, responsive layout, and the complete canonical `content/busa-clm-app/` artifact.
...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa CLM overview"></td>
    <td width="50%"><img src="assets/screenshots/contracts.webp" alt="Busa CLM contract inventory"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/obligations.webp" alt="Busa CLM obligations"></td>
    <td width="50%"><img src="assets/screenshots/renewals.webp" alt="Busa CLM renewals"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" width="100%"><img src="assets/screenshots/approvals.webp" alt="Busa CLM approvals"></td>
  </tr>
  <tr>
...
Three Bases under one application Folder (`busa-clm`), declared in
`content/busa-clm-app/app/js/config.js` and the generated template sidecars under `content/`:
...
Start `pnpm --dir content/busa-clm-app dev` only when local preview/debugging is explicitly
requested.
...
- the skill contains the complete canonical `content/busa-clm-app/` project and
  `pnpm --dir content/busa-clm-app dev` remains supported;
...
- `pnpm --dir content/busa-clm-app run check` and `node --test` pass.
