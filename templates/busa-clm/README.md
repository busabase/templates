...
Busa CLM is a lightweight, Busabase-backed App-in-Skill contract lifecycle
...
It is deliberately separate from `busa-legal-contracts`: use this for
...
```bash
pnpm --dir skills/busa-clm/content/busa-clm-app dev
```
...
<table>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/approvals.webp" alt="Busa CLM approvals"></td>
  </tr>
  <tr>
