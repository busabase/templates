...
app.get("/health", (context) => context.json({ ok: true, app: "busa-clm" }));
...
app.onError((error, context) => {
  console.error("busa-clm server error", error instanceof Error ? error.message : error);
