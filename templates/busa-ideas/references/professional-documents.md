...
Read this reference before drafting, revising, or marking a Busa Ideas document complete. The
...
- `[Q:<record-id>]` for an answered Busa Ideas consultant question;
...
| Requirement type | Question to answer in Busa Ideas | Typical destination |
| --- | --- | --- |
