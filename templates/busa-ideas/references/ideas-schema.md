...
Use this schema when reading or writing Busa Ideas's Busabase Bases. Field
slugs are kebab-case in Busabase and normalized to snake_case in app code
(`content/busa-ideas-app/app/js/ideas-model.js`,
`content/busa-ideas-app/app/js/providers/busabase-provider.js`).

## Ideas (`busa-ideas-ideas`)
...
## Documents (`busa-ideas-documents`)
...
## Questions (`busa-ideas-questions`)
