...
Busa Ideas is a Busabase Cloud App-in-Skill. Its canonical product surface is
...
All state lives in the `busa-ideas` Folder in the selected Space.
...
- The `busa-ideas` Folder exists with all four resources.
