...
app.get("/health", (context) => context.json({ ok: true, app: "busa-ideas" }));
...
app.onError((error, context) => {
  console.error("busa-ideas server error", error instanceof Error ? error.message : error);
