...
// This mirrors busa-legal-casebase-ingest's execute_decisions.mjs
...
import { itemExecution, normalizeItemRow } from "../content/busa-legal-firm-radar-app/app/js/firm-radar-model.js";
  ...
  for (const row of decided) {
    ...
    if (apply) {
      await client.records.changeRequest({
        ...
        author: "busa-legal-firm-radar-execute-decisions",
