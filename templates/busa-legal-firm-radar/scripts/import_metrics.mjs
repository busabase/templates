...
import { ITEM_LABEL_EN } from "../content/busa-legal-firm-radar-app/app/js/firm-radar-model.js";
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  if (existing) {
    await client.records.changeRequest({
      ...
      fields: normalized,
      message,
      author: "busa-legal-firm-radar-import",
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-legal-firm-radar-import",
    autoMerge: true,
  });
  return "created";
}
