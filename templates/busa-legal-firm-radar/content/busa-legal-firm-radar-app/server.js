...
const AIRAPP_ID = "busa-legal-firm-radar";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-legal-firm-radar" }));
...
app.onError((error, context) => {
  console.error("busa-legal-firm-radar server error", error instanceof Error ? error.message : error);
