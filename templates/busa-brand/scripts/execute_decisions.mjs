#!/usr/bin/env node
// Trusted hand-off step. Busa Brand's AirApp only ever proposes an "adopt as
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Busa Brand Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
