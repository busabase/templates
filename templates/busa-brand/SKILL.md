...
Busa Brand is a Busabase Cloud App-in-Skill. Its canonical product surface
...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual
   quality, responsive layout, and the complete canonical `content/busa-brand-app/` artifact.
...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa Brand message house"></td>
    <td width="50%"><img src="assets/screenshots/drift.webp" alt="Busa Brand drift alerts"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/narrative.webp" alt="Busa Brand narrative"></td>
    <td width="50%"><img src="assets/screenshots/stories.webp" alt="Busa Brand story bank"></td>
  </tr>
  <tr>
...
On invocation, check the `busa-brand-profile` settings row for readiness.
...
Three Bases under one application Folder (`busa-brand`), declared in
`content/busa-brand-app/app/js/config.js` and the generated template sidecars under `content/`:
...
- `settings`: one row per `kind` — `busa-brand-profile` (brand profile, style/tone, official URLs, risk policy, monitored channels) and `busa-brand-lock`.
...
Start `pnpm --dir content/busa-brand-app dev` only when local preview/debugging is explicitly
requested.
