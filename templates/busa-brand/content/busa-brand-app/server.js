...
app.get("/health", (context) => context.json({ ok: true, app: "busa-brand" }));
...
app.onError((error, context) => {
  console.error("busa-brand server error", error instanceof Error ? error.message : error);
