...
const state = {
  ...
  route: parseRoute(),
  query: "",
  lang: normalizeLang(params.get("lang") || localStorage.getItem("busa-local-model-lab-language") || "auto"),
  messages: { en: {}, zh: {} },
  busy: false,
  loadingMore: new Set(),
  settingsTab: "guide",
...
els.language.addEventListener("change", () => {
  ...
  localStorage.setItem("busa-local-model-lab-language", state.lang);
  render();
});
