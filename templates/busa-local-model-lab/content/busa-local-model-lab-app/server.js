...
const AIRAPP_ID = "busa-local-model-lab";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-local-model-lab" }));
...
app.onError((error, context) => {
  console.error("busa-local-model-lab server error", error instanceof Error ? error.message : error);
