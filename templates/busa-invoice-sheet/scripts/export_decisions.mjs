#!/usr/bin/env node
// Trusted export step. Busa Invoice Sheet's AirApp only ever writes a human
...
import { computeInvoiceFromRow } from "../content/busa-invoice-sheet-app/app/js/invoice-model.js";
    ...
    if (apply) {
      ...
      for (const invoice of batchInvoices) {
        ...
        await client.records.changeRequest({
          ...
          author: "busa-invoice-sheet-exporter",
