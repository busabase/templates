...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Invoice Sheet must be Cloud-only");
...
console.log(`Busa Invoice Sheet AirApp checks OK (${files.length} files)`);
