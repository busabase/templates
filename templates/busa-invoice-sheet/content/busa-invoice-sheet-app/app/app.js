...
const state = {
  ...
  uploadOpen: false,
  lang: localStorage.getItem("busa-invoice-sheet-lang") || "auto",
  notice: "",
  pagination: {},
  totalCount: {},
  loadingMore: false,
...
async function loadState({ quiet = false } = {}) {
  ...
  window.dispatchEvent(new CustomEvent("busa-invoice-sheet:state", { detail: data }));
  render();
}
    ...
    <aside class="sidebar" id="appSidebar">
      <div class="brand">
        ...
        <div class="brand-copy">
          <div class="brand-title">Busa Invoice Sheet</div>
...
document.addEventListener("change", (event) => {
  ...
  if (lang) {
    state.lang = lang;
    localStorage.setItem("busa-invoice-sheet-lang", lang);
    render();
  }
});
