...
const AIRAPP_ID = "busa-invoice-sheet";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-invoice-sheet" }));
...
app.onError((error, context) => {
  console.error("busa-invoice-sheet server error", error instanceof Error ? error.message : error);
