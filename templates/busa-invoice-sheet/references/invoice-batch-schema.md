# Busa Invoice Sheet Batch Schema

Use this schema when reading or writing Busa Invoice Sheet's Busabase
...
code (`content/busa-invoice-sheet-app/app/js/providers/busabase-provider.js`,
`content/busa-invoice-sheet-app/app/js/invoice-model.js`).
...
## Invoices (`busa-invoice-sheet-invoices`)
...
## Settings (`busa-invoice-sheet-settings`)
