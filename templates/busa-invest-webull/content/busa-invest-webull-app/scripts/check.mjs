...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Invest (Webull) must be Cloud-only");
if (!configText.includes("readOnly: true")) throw new Error("Busa Invest (Webull) AirApp must declare readOnly: true");
if (!configText.includes("writeProcedures: []"))
  throw new Error("Busa Invest (Webull) AirApp must declare no writeProcedures");
...
console.log(`Busa Invest (Webull) AirApp checks OK (${files.length} files)`);
