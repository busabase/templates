...
const AIRAPP_ID = "busa-invest-webull";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-invest-webull" }));
...
app.onError((error, context) => {
  console.error("busa-invest-webull server error", error instanceof Error ? error.message : error);
