...
const AIRAPP_ID = "busa-family-office";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-family-office" }));
...
app.onError((error, context) => {
  console.error("busa-family-office server error", error instanceof Error ? error.message : error);
