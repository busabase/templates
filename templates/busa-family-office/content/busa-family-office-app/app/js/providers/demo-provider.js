...
function demoSnapshot(scenario) {
  const entities = [
    entity("individual-principal", "Jordan Lee (Individual)", "INDIVIDUAL", "Jordan Lee"),
  ...
  return buildSnapshot({
    ...
    accounts,
    holdings,
    source: "busa-family-office-demo",
    warnings,
  });
}
...
export const demoProvider = {
  ...
  async getState() {
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "demo://busa-family-office/config.json",
        is_example: false,
