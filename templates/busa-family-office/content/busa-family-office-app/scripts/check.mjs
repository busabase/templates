...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Family Office must be Cloud-only");
...
console.log(`Busa Family Office AirApp checks OK (${files.length} files)`);
