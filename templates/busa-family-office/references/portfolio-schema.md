# Busa Family Office Schema

Use this schema when reading or writing Busa Family Office's Busabase Bases.
Field slugs are kebab-case in Busabase and normalized to snake_case in app
code (`content/busa-family-office-app/app/js/providers/busabase-provider.js`,
`content/busa-family-office-app/app/js/office-model.js`, `scripts/import_csv.mjs`). The consolidated
...
## Entities (`busa-family-office-entities`)
...
## Accounts (`busa-family-office-accounts`)
...
## Holdings (`busa-family-office-holdings`)
...
## Settings (`busa-family-office-settings`)
