...
app.get("/health", (context) => context.json({ ok: true, app: "busa-ads" }));
...
app.onError((error, context) => {
  console.error("busa-ads server error", error instanceof Error ? error.message : error);
