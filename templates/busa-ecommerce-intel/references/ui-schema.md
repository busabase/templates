# Busa Ecommerce Intel Schema

Use this schema when reading or writing Busa Ecommerce Intel's Busabase
Bases. Field slugs are kebab-case in Busabase and normalized to snake_case in
app code (`content/busa-ecommerce-intel-app/app/js/providers/busabase-provider.js`,
`content/busa-ecommerce-intel-app/app/js/ecommerce-model.js`). The batch rollup metrics
...
## Signals (`busa-ecommerce-intel-signals`)
...
## Actions (`busa-ecommerce-intel-actions`)
...
## Drafts (`busa-ecommerce-intel-drafts`)
...
## Sources (`busa-ecommerce-intel-sources`)
...
## Settings (`busa-ecommerce-intel-settings`)
...
(`operationForDecision()` in `content/busa-ecommerce-intel-app/app/js/ecommerce-model.js`) for every
