...
const AIRAPP_ID = "busa-ecommerce-intel";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-ecommerce-intel" }));
...
app.onError((error, context) => {
  console.error("busa-ecommerce-intel server error", error instanceof Error ? error.message : error);
