...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Ecommerce Intel must be Cloud-only");
...
console.log(`Busa Ecommerce Intel AirApp checks OK (${files.length} files)`);
