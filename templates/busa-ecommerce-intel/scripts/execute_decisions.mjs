...
import { operationForDecision } from "../content/busa-ecommerce-intel-app/app/js/ecommerce-model.js";
...
async function markDone(client, existing, fields, message) {
  return client.records.changeRequest({
    ...
    message,
    author: "busa-ecommerce-intel-execute-decisions",
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Busa Ecommerce Intel Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
