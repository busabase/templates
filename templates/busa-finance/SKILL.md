...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa Finance model overview"></td>
    <td width="50%"><img src="assets/screenshots/checks.webp" alt="Busa Finance model audit checks"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/workbook.webp" alt="Busa Finance workbook tab contract"></td>
    <td width="50%"></td>
  </tr>
  <tr>
...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual quality, responsive layout, and the complete canonical `content/busa-finance-app/` artifact.
...
Three Bases under one application Folder (`busa-finance`), declared in
`content/busa-finance-app/app/js/config.js` and the generated template sidecars under `content/`:
...
```bash
node skills/busa-finance/scripts/build_three_statement_model.mjs \
...
Start `pnpm --dir content/busa-finance-app dev` only when local preview/debugging is explicitly
requested.
...
`content/busa-finance-app/app/js/finance-model.js`.

## The Domain Model

`content/busa-finance-app/app/js/finance-model.js` documents and implements the entire pure
...
(`content/busa-finance-app/app/js/providers/busabase-provider.js`) and the offline `?demo=`
scenario (`content/busa-finance-app/app/js/providers/demo-provider.js`), so both always agree on
the snapshot shape.
...
```bash
node skills/busa-finance/scripts/build_three_statement_model.mjs --apply
node skills/busa-finance/scripts/execute_decisions.mjs --apply
pnpm --dir skills/busa-finance/content/busa-finance-app dev
python3 skills/busa-finance/scripts/build_three_statement_model.py --output /tmp/model.xlsx --company "ExampleCo"
```
