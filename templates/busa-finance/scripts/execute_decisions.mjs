#!/usr/bin/env node
// Trusted hand-off step. Busa Finance's AirApp only ever records a
...
import { computeCheckFromRow } from "../content/busa-finance-app/app/js/finance-model.js";
...
async function main() {
  ...
  if (!resources.folder || resources.missing.length) {
    throw new Error("Busa Finance Busabase resources are not provisioned yet; run the AirApp setup first.");
  }
