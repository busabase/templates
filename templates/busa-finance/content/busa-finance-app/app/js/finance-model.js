// Domain model for Busa Finance's three-statement model review desk, ported
...
// kelly-deal-scorer). Busa Finance never had a busabase-provider.ts to
...
// local-file-provider.ts (secrets_required is always false — Busa Finance
...
export function demoSnapshot(lang = "en") {
  ...
  const model = {
    ...
    warnings: [],
    workbook: {
      last_generated_path: "/tmp/busa-finance-demo.xlsx",
