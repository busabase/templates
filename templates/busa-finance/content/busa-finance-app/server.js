...
app.get("/health", (context) => context.json({ ok: true, app: "busa-finance" }));
...
app.onError((error, context) => {
  console.error("busa-finance server error", error instanceof Error ? error.message : error);
