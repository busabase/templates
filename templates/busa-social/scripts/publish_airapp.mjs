#!/usr/bin/env node
// Push this skill's current local content/busa-social-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/busa-social-app/ files; scripts/setup.mjs
...
const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "busa-social-app");
