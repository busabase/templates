...
function demoDrafts() {
  const raw = [
    ...
    },
    {
      ...
      body: "The follower trend on Busa Social is 14 lines of inline SVG. Here's the whole function, and why zero-deps is a feature, not a flex.",
  ...
  return [
    {
      ...
      shots: [
        ...
        shot(5, "Cut to laptop with the app open", "Busa Social, running local.", 6),
      ],
...
function demoEngagement() {
  return [
    ...
    eng(
      ...
      "question",
      "high",
      "Happy to answer anything specific! Busa Social is local-first and reads your own accounts — no cloud middleman. What matters most for your workflow?",
    ),
    eng(
      "eng-3",
      "instagram",
...
function localizeEchoZh(snapshot) {
  ...
  const draftCopy = {
    ...
    "draft-2": {
      hook: "做仪表盘不需要图表库。",
      body: "Busa Social 的粉丝趋势就是 14 行内联 SVG。这是整个函数，以及为什么零依赖是功能而非炫技。",
      cta: "完整代码在线程里。",
    },
    "draft-3": {
...
export const demoProvider = {
  ...
  async getState() {
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "demo://busa-social/config.json",
        is_example: false,
      ...
      demo_visuals: demoVisualsForApp("busa-social"),
      snapshot: { ...snapshot, demo_visuals: demoVisualsForApp("busa-social") },
    };
  },
