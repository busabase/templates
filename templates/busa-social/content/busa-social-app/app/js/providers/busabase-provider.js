...
async function readAll() {
  ...
  const crisisRow = settings.get("busa-social-crisis");
  const sovRow = settings.get("busa-social-share-of-voice");
...
export const busabaseProvider = {
  ...
  async getState() {
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "busabase:base/busa-social-accounts",
        is_example: false,
