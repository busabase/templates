...
app.get("/health", (context) => context.json({ ok: true, app: "busa-social" }));
...
app.onError((error, context) => {
  console.error("busa-social server error", error instanceof Error ? error.message : error);
