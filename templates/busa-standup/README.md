...
On each invocation the agent parses raw updates (busa-messenger snapshot, chat exports, shared docs, pasted text) into a payload and runs the single trusted write path:
