...
Use this schema when reading or writing Busa Standup's Busabase Bases. Field
slugs are kebab-case in Busabase and normalized to snake_case in app code
(`content/busa-standup-app/app/js/providers/busabase-provider.js`, `content/busa-standup-app/app/js/standup-model.js`).
...
## Check-ins (`busa-standup-checkins`)
...
## Blockers (`busa-standup-blockers`)
...
## Reminders (`busa-standup-reminders`)
...
## Settings (`busa-standup-settings`)
