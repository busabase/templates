#!/usr/bin/env node
// Trusted hand-off step. Busa Standup's AirApp only ever writes a human
...
async function main() {
  ...
  console.log(JSON.stringify({ executed_at: now, dry_run: !apply, source: "busa-standup", results }, null, 2));
