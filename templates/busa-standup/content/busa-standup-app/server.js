...
app.get("/health", (context) => context.json({ ok: true, app: "busa-standup" }));
...
app.onError((error, context) => {
  console.error("busa-standup server error", error instanceof Error ? error.message : error);
