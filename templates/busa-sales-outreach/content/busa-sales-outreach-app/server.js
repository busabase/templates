...
const AIRAPP_ID = "busa-sales-outreach";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-sales-outreach", mode: "outreach-desk" }));
...
app.onError((error, context) => {
  console.error("busa-sales-outreach server error", error instanceof Error ? error.message : error);
