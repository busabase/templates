...
test("the desk always names the next bounded command", () => {
  assert.equal(nextStep(createSalesOutreachDesk([])).command, "/busa-sales-outreach profile");
  assert.equal(nextStep(createSalesOutreachDesk([profileRecord])).command, "/busa-sales-outreach research");
  assert.equal(nextStep(createSalesOutreachDesk(sample)).command, "/busa-sales-outreach research");
  ...
  assert.equal(nextStep(createSalesOutreachDesk(queued)).command, "/busa-sales-outreach send");
