...
import { appConfig } from "../content/busa-sales-outreach-app/app/js/config.js";

export { appConfig };

const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "busa-sales-outreach-app");
