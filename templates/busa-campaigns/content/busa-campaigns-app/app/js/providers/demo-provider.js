...
function demoSends() {
  const sends = [
    ...
    send(
      ...
      [],
      "The monthly dispatch is drafted; the operator asked to tighten the intro and lift the recipe link above the fold.",
...
export const demoProvider = {
  ...
  async getState() {
    ...
    snapshot.source = "busa-campaigns-demo";
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "demo://busa-campaigns/config.json",
        is_example: false,
        operator: {
          name: "Jordan Lee",
          role: "Marketing Lead",
