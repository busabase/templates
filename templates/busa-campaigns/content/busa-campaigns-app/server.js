...
const AIRAPP_ID = "busa-campaigns";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-campaigns" }));
...
app.onError((error, context) => {
  console.error("busa-campaigns server error", error instanceof Error ? error.message : error);
