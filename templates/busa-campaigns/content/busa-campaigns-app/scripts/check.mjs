...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Campaigns must be Cloud-only");
...
console.log(`Busa Campaigns AirApp checks OK (${files.length} files)`);
