...
app.get("/health", (context) => context.json({ ok: true, app: "busa-mv" }));
...
// Busa MV-specific addition (not part of the shared template every other
...
app.onError((error, context) => {
  console.error("busa-mv server error", error instanceof Error ? error.message : error);
