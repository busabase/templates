// Busa MV's Busabase resource map. One workspace = exactly one MV project
...
export const appConfig = {
  ...
  airApp: { name: "Busa MV", slug: "busa-mv-app", resourceKey: "busa-mv-app" },
  bases: [
    {
      key: "project",
      name: "Project",
      slug: "busa-mv-project",
