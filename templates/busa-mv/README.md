...
Busa MV is a Busabase-backed App-in-Skill workbench for turning an existing MP3 into a pure-visual music video: a one-line concept, a cast with reference cards, and a storyboard of shots where each image/video can be AI-generated or uploaded.
...
```bash
pnpm --dir content/busa-mv-app install
pnpm --dir content/busa-mv-app run build:sdk
pnpm --dir content/busa-mv-app dev
```
