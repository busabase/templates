#!/usr/bin/env node
// Trusted hand-off step for AI generation. Busa MV's AirApp can only WRITE A
...
import { collectShotReferences, storyboardPrompt } from "../content/busa-mv-app/app/js/mv-model.js";
