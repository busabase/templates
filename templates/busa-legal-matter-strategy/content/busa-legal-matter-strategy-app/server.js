...
const AIRAPP_ID = "busa-legal-matter-strategy";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-legal-matter-strategy" }));
...
app.onError((error, context) => {
  console.error("busa-legal-matter-strategy server error", error instanceof Error ? error.message : error);
