// Pure domain logic for busa-legal-matter-strategy, ported verbatim (same
...
// busa-legal-casebase-ingest's and busa-legal-firm-radar's items Base.
...
export const APP_ID = "busa-legal-matter-strategy";
...
// busa-legal-casebase-ingest's and busa-legal-firm-radar's deriveActivityLog.
...
// busa-legal-casebase-ingest's/busa-legal-firm-radar's more conservative
...
export function assembleSnapshot({
  ...
  const snapshot = {
    schema_version: "1",
    generated_at: now,
    source: "busa-legal-matter-strategy",
    workspace,
    metrics: {},
    entities,
    items,
