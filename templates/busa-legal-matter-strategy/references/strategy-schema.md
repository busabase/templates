...
in app code (`content/busa-legal-matter-strategy-app/app/js/providers/busabase-provider.js`,
`content/busa-legal-matter-strategy-app/app/js/matter-strategy-model.js`). Metrics and the recent-activity feed
...
## Items (`busa-legal-matter-strategy-items`)
...
## Entities (`busa-legal-matter-strategy-entities`)
...
## Checks (`busa-legal-matter-strategy-checks`)
...
## Settings (`busa-legal-matter-strategy-settings`)
