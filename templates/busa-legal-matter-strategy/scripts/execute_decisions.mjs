...
// mirrors busa-legal-casebase-ingest's and busa-legal-firm-radar's
...
import {
  itemExecution,
  normalizeItemRow,
} from "../content/busa-legal-matter-strategy-app/app/js/matter-strategy-model.js";
  ...
  for (const row of decided) {
    ...
    if (apply) {
      await client.records.changeRequest({
        ...
        author: "busa-legal-matter-strategy-execute-decisions",
