...
import { ITEM_LABEL_EN } from "../content/busa-legal-matter-strategy-app/app/js/matter-strategy-model.js";
...
async function upsert(client, declared, existing, fields, message, apply) {
  ...
  if (existing) {
    await client.records.changeRequest({
      ...
      fields: normalized,
      message,
      author: "busa-legal-matter-strategy-create-strategy-batch",
  ...
  await client.bases.createChangeRequest({
    ...
    fields: normalized,
    message,
    submittedBy: "busa-legal-matter-strategy-create-strategy-batch",
    autoMerge: true,
  });
  return "created";
}
