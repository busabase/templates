...
app.get("/health", (context) => context.json({ ok: true, app: "busa-feedback" }));
...
app.onError((error, context) => {
  console.error("busa-feedback server error", error instanceof Error ? error.message : error);
