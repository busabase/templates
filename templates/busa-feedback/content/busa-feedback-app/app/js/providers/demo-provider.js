...
function demoSyncLog() {
  return [
    log("2026-06-27T15:30:00.000Z", "busa-feedback", "ingest", "Imported 2 interview notes from user-interviews.", 2),
    log("2026-06-30T09:05:00.000Z", "busa-feedback", "ingest", "Imported 3 App Store reviews (manual export).", 3),
    log("2026-07-01T09:10:00.000Z", "busa-feedback", "ingest", "Imported 3 NPS survey responses.", 3),
    log(
...
export const demoProvider = {
  ...
  async getState() {
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "demo://busa-feedback/config.json",
        is_example: false,
