...
Busa Feedback is a Busabase-backed App-in-Skill voice-of-customer desk. It
...
gives the operator a roadmap decision queue.
...
```bash
pnpm --dir content/busa-feedback-app install
pnpm --dir content/busa-feedback-app dev
```
...
Busa Feedback sits downstream of the other kelly skills. busa-email
(support threads), busa-messenger (Discord/Slack posts), and busa-social
...
drafts roadmap proposals directly into Busabase, and — only after the operator
