...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa Digital Human must be Cloud-only");
if (
...
console.log(`Busa Digital Human AirApp checks OK (${files.length} files)`);
