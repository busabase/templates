...
const AIRAPP_ID = "busa-digital-human";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-digital-human" }));
...
app.onError((error, context) => {
  console.error("busa-digital-human server error", error instanceof Error ? error.message : error);
