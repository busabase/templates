#!/usr/bin/env node
// Push this skill's current local content/busa-digital-human-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/busa-digital-human-app/ files; scripts/setup.mjs
...
import { appConfig } from "../content/busa-digital-human-app/app/js/config.js";

const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "busa-digital-human-app");
