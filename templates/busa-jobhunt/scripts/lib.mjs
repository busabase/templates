...
import { appConfig } from "../content/busa-jobhunt-app/app/js/config.js";

export { appConfig };

const appRoot = path.join(path.dirname(fileURLToPath(import.meta.url)), "..", "content", "busa-jobhunt-app");
