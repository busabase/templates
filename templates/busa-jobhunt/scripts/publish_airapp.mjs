#!/usr/bin/env node
// Push this skill's current local content/busa-jobhunt-app/ code to its deployed AirApp: creates it
...
// change takes effect. Use this after editing content/busa-jobhunt-app/ files; scripts/setup.mjs
