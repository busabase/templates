export const appConfig = {
  ...
  airApp: { name: "Busa JobHunt", slug: "busa-jobhunt-app", resourceKey: "busa-jobhunt-app" },
  bases: [
    {
      key: "profile",
      name: "求职档案",
      slug: "busa-jobhunt-profile",
