...
app.get("/health", (context) => context.json({ ok: true, app: "busa-jobhunt", mode: "outreach-desk" }));
...
app.onError((error, context) => {
  console.error("busa-jobhunt server error", error instanceof Error ? error.message : error);
