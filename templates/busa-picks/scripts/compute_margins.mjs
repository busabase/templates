...
import { computeMarginCard, freightRulesMap, platformsMap } from "../content/busa-picks-app/app/js/picks-model.js";
...
async function main() {
  ...
  for (const candidate of candidates) {
    ...
    if (before !== after) {
      ...
      await client.records.changeRequest({
        ...
        author: "busa-picks-compute-margins",
  ...
  if (changed > 0) {
    await client.bases.createChangeRequest({
      ...
      submittedBy: "busa-picks-compute-margins",
      autoMerge: true,
    });
  }
