...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa Picks overview"></td>
    <td width="50%"><img src="assets/screenshots/candidates.webp" alt="Busa Picks candidates"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/decisions.webp" alt="Busa Picks decision queue"></td>
    <td width="50%"><img src="assets/screenshots/detail.webp" alt="Busa Picks margin card"></td>
  </tr>
  <tr>
...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual quality, responsive layout, and the complete canonical `content/busa-picks-app/` artifact.
...
Six Bases under one application Folder (`busa-picks`), declared in `content/busa-picks-app/app/js/config.js` and the generated template sidecars under `content/`:
...
Default behavior is AirApp-first — give the user the clickable AirApp URL. Start `pnpm --dir content/busa-picks-app dev` only when local preview/debugging is explicitly requested.
...
```bash
node skills/busa-picks/scripts/ingest_trends.mjs payload.json
node skills/busa-picks/scripts/compute_margins.mjs
node skills/busa-picks/scripts/execute_decisions.mjs
node skills/busa-picks/scripts/execute_decisions.mjs --apply
pnpm --dir skills/busa-picks/content/busa-picks-app dev
```

In normal use, invoke `/busa-picks`, let the skill sweep and ingest what's due, and open the AirApp.
