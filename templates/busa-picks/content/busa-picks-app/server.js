...
app.get("/health", (context) => context.json({ ok: true, app: "busa-picks" }));
...
app.onError((error, context) => {
  console.error("busa-picks server error", error instanceof Error ? error.message : error);
