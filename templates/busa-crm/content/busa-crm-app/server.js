...
app.get("/health", (context) => context.json({ ok: true, app: "busa-crm" }));
...
app.onError((error, context) => {
  console.error("busa-crm server error", error instanceof Error ? error.message : error);
