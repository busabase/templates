...
function configSummary(operatorPayload, channelsPayload) {
  ...
  return {
    config_path: "busabase:base/busa-crm-settings",
    is_example: false,
    operator: {
...
export const busabaseProvider = {
  ...
  async getState() {
    ...
    const operatorRow = settings.get("busa-crm-operator") || {};
    const channelsRow = settings.get("busa-crm-channels") || {};
    const lockRow = settings.get("busa-crm-lock") || {};
