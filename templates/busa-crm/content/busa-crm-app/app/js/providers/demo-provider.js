...
function demoSnapshot(scenario) {
  ...
  const deals = [
    ...
    deal(
      ...
      "2026-06-27T14:00:00.000Z",
      "open",
      "Rework the draft per the operator's note: say 'SOC 2 audit underway', never 'certified'.",
    ),
    deal(
  ...
  const followups = [
    ...
    followup(
      ...
      "David asked which certifications are complete; the first draft overstated SOC 2 status and the operator asked for a revision.",
      ["legal"],
      "2026-07-05",
      "changes_requested",
...
export const demoProvider = {
  ...
  async getState() {
    ...
    return {
      ...
      lock: null,
      config_summary: {
        config_path: "demo://busa-crm/config.json",
        is_example: false,
        operator: { name: "Jordan Lee", role: "Founder", company: "Atlas Studio LLC", timezone: "Asia/Shanghai" },
        pipeline_stages: PIPELINE_STAGES,
        base_currency: "USD",
