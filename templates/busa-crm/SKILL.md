---
name: busa-crm
description: Busabase-backed App-in-Skill CRM operator for contacts, companies, deals, and agent-drafted follow-ups in a reviewable follow-up queue. Use when the user invokes $busa-crm or /busa-crm, mentions CRM, pipeline, contacts, companies, deals, follow-ups, relationship management, meeting-note capture, outreach drafts, next steps, or wants to review/approve agent-drafted follow-up messages before they are sent through other channels.
metadata:
  category: sales-crm
  tags:
    - risk:gated-write
...
Busa CRM is a Busabase Cloud App-in-Skill. Its canonical product surface is the
...
1. Read and follow `$kelly-app-skill-creator` for product behavior, visual
   quality, responsive layout, and the complete canonical `content/busa-crm-app/` artifact.
...
<table>
  <tr>
    <td width="50%"><img src="assets/screenshots/overview.webp" alt="Busa CRM overview"></td>
    <td width="50%"><img src="assets/screenshots/deals.webp" alt="Busa CRM deal pipeline"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/contacts.webp" alt="Busa CRM contacts"></td>
    <td width="50%"><img src="assets/screenshots/followups.webp" alt="Busa CRM follow-up queue"></td>
  </tr>
  <tr>
...
Six Bases under one application Folder (`busa-crm`), declared in
`content/busa-crm-app/app/js/config.js` and the generated template sidecars under `content/`:
...
1. When the operator feeds new material (emails, meeting notes, chat asks): upsert
...
2. Give the operator the AirApp URL (or local preview URL) to review the pipeline
...
screenshots (`content/busa-crm-app/app/js/providers/demo-provider.js`). `?demo=overview`,
...
- the skill contains the complete canonical `content/busa-crm-app/` project and
  `pnpm --dir content/busa-crm-app dev` remains supported;
...
- `pnpm --dir content/busa-crm-app run check` and `node --test` pass.
