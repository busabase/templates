...
if (!configText.includes('deployment: "cloud"')) throw new Error("Busa PPT Factory must be Cloud-only");
...
console.log(`Busa PPT Factory AirApp checks OK (${files.length} files)`);
