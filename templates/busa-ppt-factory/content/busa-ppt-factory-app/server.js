...
const AIRAPP_ID = "busa-ppt-factory";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-ppt-factory" }));
...
app.onError((error, context) => {
  console.error("busa-ppt-factory server error", error instanceof Error ? error.message : error);
