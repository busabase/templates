...
Busa PPT Factory is a Busabase-backed App-in-Skill desk for producing many
...
<table>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/projects.webp" alt="Busa PPT Factory projects"></td>
    <td width="50%"><img src="assets/screenshots/decks.webp" alt="Busa PPT Factory decks"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="assets/screenshots/style.webp" alt="Busa PPT Factory style system"></td>
  </tr>
  <tr>
...
```bash
pnpm --dir skills/busa-ppt-factory/content/busa-ppt-factory-app dev
```
...
`content/busa-ppt-factory-app/app/js/config.js` (see `references/ppt-factory-schema.md`). Resources
...
Generated exports live under `skills/busa-ppt-factory/exports/` by default
and are gitignored.
