...
// ?demo=1 contract used across Busa App-in-Skills. The five products, seven
// channel rows, five inventory rows, and four activity entries below are
...
function demoConfigSummary(zh) {
  const l = L(zh);
  return {
    config_path: "demo://busa-product-hub/config.json",
    is_example: false,
    seller: {
      brand: "Nimbus Home",
...
function demoReviewItems(zh) {
  ...
  return [
    ...
    },
    {
      ...
      type: "spec_claim",
      status: "needs_review",
      title: l("Cite the UN38.3 expiry before it reaches a quote", "在报价前为 UN38.3 证书补上出处"),
      summary: l(
        "The UN38.3 certificate's expiry date was logged from a supplier email with no document or page cited, and it expires in 13 days. Get a page/section citation (or the certificate file itself) before this appears on a buyer quote.",
        "UN38.3 证书的到期日仅来自供应商邮件转述，未标注文件或页码出处，且 13 天后到期。在其出现在买家报价前，需补齐文档/页码出处（或证书原件）。",
      ),
      risk: "medium",
      recommendation: "request_changes",
      evidence: [
        l("certificates.source-note reads only \"from supplier email\", no document or page cited.", "certificates.source-note 仅写“来自供应商邮件”，未注明文件或页码。"),
        l("Certificate status is expiring_soon (13 days out).", "证书状态为 expiring_soon（13 天后到期）。"),
      ],
      decision_note: "",
      decided_at: "",
...
function demoCertificates(zh) {
  const l = L(zh);
  return [
    {
      certificate_id: "cert-aurora-lamp-ce",
      product_id: "prod-aurora-lamp",
      cert_type: "CE",
      issuer: l("TÜV Rheinland Shenzhen", "深圳莱茵TÜV"),
    ...
    {
      certificate_id: "cert-lunchbox-fcc",
      product_id: "prod-lunchbox",
      cert_type: "FCC",
      issuer: l("Bay Area Compliance Labs", "湾区合规实验室"),
      cert_number: "FCC-LB-2025-0087",
      issued_date: "2025-08-20",
      expiry_date: "2026-08-20",
      file: null,
      source_note: "compliance-folder/lunchbox-fcc.pdf p.1",
    },
    {
      certificate_id: "cert-spice-rack-rohs",
      product_id: "prod-spice-rack",
      cert_type: "RoHS",
      issuer: l("SGS Ningbo", "宁波通标 SGS"),
      cert_number: "ROHS-SR-2025-0033",
      issued_date: "2025-05-01",
      expiry_date: "2026-05-01",
      file: null,
      source_note: "spec-sheet.pdf p.4",
    },
    {
      certificate_id: "cert-laundry-basket-ukca",
      product_id: "prod-laundry-basket",
      cert_type: "UKCA",
      issuer: l("Intertek Anji", "安吉天祥 Intertek"),
      cert_number: "UKCA-LBASK-2026-0011",
      issued_date: "2026-06-01",
      expiry_date: "2026-12-01",
      file: null,
      source_note: "uploaded by operator",
    },
    {
      certificate_id: "cert-scale-un383",
      product_id: "prod-scale",
      cert_type: "UN38.3",
      issuer: l("Shenzhen Weightek battery lab", "深圳称芯科技电池实验室"),
      cert_number: "UN383-KS-2025-0059",
      issued_date: "2025-07-20",
      expiry_date: "2026-07-20",
      file: null,
      source_note: l("from supplier email", "来自供应商邮件"),
    },
  ];
}
...
export const demoProvider = {
  ...
  async getState() {
    ...
    const certificates = demoCertificates(zh);
