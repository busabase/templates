...
const AIRAPP_ID = "busa-product-hub";
...
app.get("/health", (context) => context.json({ ok: true, app: "busa-product-hub" }));
...
app.onError((error, context) => {
  console.error("busa-product-hub server error", error instanceof Error ? error.message : error);
