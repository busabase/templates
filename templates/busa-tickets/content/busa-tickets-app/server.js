...
app.get("/health", (context) => context.json({ ok: true, app: "busa-tickets" }));
...
app.onError((error, context) => {
  console.error("busa-tickets server error", error instanceof Error ? error.message : error);
